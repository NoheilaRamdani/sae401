...
public function getSuggestedBy(): User { return $this->suggestedBy; }
public function setSuggestedBy(User $suggestedBy): self { $this->suggestedBy = $suggestedBy; return $this; }
